...
const CheckOut = () => {
  ...
  const handleService = (event) => {
    ...
    fetch("https://car-doctor-server-eta-lovat.vercel.app/bookings", {
      method: "POST",
      headers: {
  ...
  return (
    <div>
      ...
      <h2 className="text-2xl lg:text-4xl text-center font-bold font-poet">
        Title: {title}
      </h2>
      ...
      <form onSubmit={handleService} className="card-body">
        ...
        <div className="form-control mt-6">
          <input
            type="submit"
            className="bg-orange-600 btn text-white"
            value="Order Confirm"
          />
        </div>
      </form>
